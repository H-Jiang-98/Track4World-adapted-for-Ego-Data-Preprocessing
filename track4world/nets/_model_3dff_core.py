    ...
    def infer(
        ...
        with torch.autocast(device_type=self.device.type, dtype=torch.float16):
            ...
            if force_projection:
                ...
                # unprojection. Keep flow2d_c unchanged because it is also the
                # absolute pixel-coordinate output returned to callers.
                flow_uv = flow2d_c.clone()
                flow_uv[..., 0] = (flow_uv[..., 0] + 0.5) / flow_uv.shape[-2]
                flow_uv[..., 1] = (flow_uv[..., 1] + 0.5) / flow_uv.shape[-3]
